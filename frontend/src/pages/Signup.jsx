    ...
    <div className="min-h-[calc(100vh-80px)] flex items-center justify-center bg-[#f4f7fb] p-4 sm:p-6">
      <div className="bg-white rounded-3xl shadow-2xl overflow-hidden max-w-4xl w-full grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="p-8 sm:p-12 flex flex-col justify-center">
          ...
          <div className="mb-5">
            <h2 className="text-2xl font-bold text-[#0c2340]">Create Account</h2>
            <p className="text-xs text-gray-400 mt-1">Sign up to get started</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-3.5">
            ...
            <button
              type="submit"
              className="w-full bg-[#1d6bf3] hover:bg-blue-700 text-white font-semibold text-xs py-3 rounded-xl shadow-md hover:shadow-lg transition duration-200 mt-2"
            >
              Sign Up
            </button>
          </form>
